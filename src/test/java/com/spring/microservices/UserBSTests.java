...
public class UserBSTests {
	...
	public void testGetUserById() {
		UserVO userVO = new UserVO(1, "Josh", "Jenny","Joshjenny@bluewin.ch","123456","Stabu iela 16","Premium");
	...
	public void testGetUserByFirstName() {
		DynamicFilteringVO vo = new DynamicFilteringVO("1", "Josh", "Jenny","ataberkyakar@gmail.com","12345");
